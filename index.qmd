...
このウェブサイトは、主として研究者を対象に気楽にウェブサイトを作成し、公開する方法を解説します。
...
$\leadsto$無料で簡単にテキストベースで作成できるツールとしてQuartoを用います。

- 直接、`.html`や`.css`ファイルを作成することなく、簡易なマークダウン記法（後述）を用いてウェブサイトを作成することができます。
- いつまで開発が続くか分かりませんが、`.html`など必要なファイルは残るので、突然死することはないでしょう。
